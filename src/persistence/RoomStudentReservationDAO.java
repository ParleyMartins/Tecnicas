...
public class RoomStudentReservationDAO extends DAO {
	...
	private static RoomStudentReservationDAO instance;

	private RoomStudentReservationDAO ( ) {
	 ...
	 */
	public static RoomStudentReservationDAO getInstance ( ) {

		if (instance != null) {
			// Nothing here.
		} else {
			instance = new RoomStudentReservationDAO();
		}
		return instance;
	}
