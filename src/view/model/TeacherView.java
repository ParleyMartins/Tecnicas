...
import view.modifying.ModifyTeacherView;
import view.registration.RegisterClientView;
import view.registration.RegisterTeacherView;
...
public class TeacherView extends ClientView {
	...
	public TeacherView(Frame parent, boolean modal) {
	...
	public void cadastrarAction() {
		...
		RegisterClientView registerTeacher = new RegisterTeacherView(new JFrame(),
				true);
	...
	public void alterarAction(int index) {
		...
		ModifyTeacherView modifyTeacher = new ModifyTeacherView(new JFrame(),
				true, index);
