...
import view.calendar.RoomReservationCalendarView;
import view.modifying.ModifyRoomView;
import view.registration.RegisterPropertyView;
import view.registration.RegisterRoomView;
import control.SupportRoom;
import exception.PatrimonioException;

public class RoomView extends PropertyView {

	private static final long serialVersionUID = 1L;

	// Constructor generates a RoomView form.
	public RoomView(Frame parent, boolean modal) {
	...
	protected void cadastrarAction() {
		...
		RegisterPropertyView registerRoom = new RegisterRoomView(new JFrame(), true);
	...
	protected void alterarAction(int index) {
		...
		ModifyRoomView modifyRoom = new ModifyRoomView(new JFrame(), true, index);
	...
	protected void visualizarAction(int index) {
		...
		try {
			RoomReservationCalendarView dayReservation = new RoomReservationCalendarView(new JFrame(),
					true, index);
