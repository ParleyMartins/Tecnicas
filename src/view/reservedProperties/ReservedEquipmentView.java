...
import view.equipmentReservations.EquipmentReservationView;
import view.equipmentReservations.ModifyReservationView;
import view.equipmentReservations.ReserveEquipmentView;
import control.ManageReserveEquipmentTeacher;
import exception.ClienteException;
import exception.PatrimonioException;
import exception.ReservaException;

public class ReservedEquipmentView extends ReservedPropertyView {
	 ...
	 * @param tempEquipment
	 */
	public ReservedEquipmentView (Frame parent, boolean modal,
	...
	protected void reserveAction ( ) {
		...
		try {
			EquipmentReservationView reservation = new ReserveEquipmentView(
	...
	protected void modifyAction (int index) {
		...
		try {
			...
			EquipmentReservationView reservation = new
					ModifyReservationView(new JFrame(), true, index,
